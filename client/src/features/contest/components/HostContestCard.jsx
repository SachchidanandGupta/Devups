    ...
    <div className="flex flex-col items-center uppercase ">
      <div className="grid grid-cols-4 gap-2 w-full">
          ...
          {contests.map((items) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xl font-bold">{items.contestName}</span>
        ...
        <div className="col-span-3   ">
           <HostContestDetails contestData={selectedContest} getProgressPercentage={getProgressPercentage} />
        </div>
      </div>
    </div>
  );
